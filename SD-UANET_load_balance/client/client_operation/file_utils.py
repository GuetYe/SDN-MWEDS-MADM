...
LastEditTime: 2024-03-18 08:39:54
LastEditors: 孙石泉
Description: 文件的操作（获取路径、文件名、分割、合并）
FilePath: \SD-UANET_load_balance\client\client_operation\file_utils.py
'''
...
class File_Utils:
    ...
    def file_split_average(self, file_path, part_count):
        ...
        '''
        if part_count == 1:
            print("<file_utils.py>  The part_count is 1，no need to split file")
            return
